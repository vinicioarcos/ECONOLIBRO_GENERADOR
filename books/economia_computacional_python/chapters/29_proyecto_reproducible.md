# Capitulo 29. Como construir un proyecto reproducible
...
El notebook asociado debe vivir en `notebooks/chapter_29/` y ejecutarse de
arriba hacia abajo.
...
Ver carpeta `exercises/chapter_29/`.
