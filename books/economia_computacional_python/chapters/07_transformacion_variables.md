# Capitulo 07. Transformacion y construccion de variables
...
El notebook asociado debe vivir en `notebooks/chapter_07/` y ejecutarse de
arriba hacia abajo.
...
Ver carpeta `exercises/chapter_07/`.
