# Capitulo 15. Heterocedasticidad y errores robustos
...
El notebook asociado debe vivir en `notebooks/chapter_15/` y ejecutarse de
arriba hacia abajo.
...
Ver carpeta `exercises/chapter_15/`.
