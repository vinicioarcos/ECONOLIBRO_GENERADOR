# Capitulo 08. Tablas estadisticas para analisis economico
...
El notebook asociado debe vivir en `notebooks/chapter_08/` y ejecutarse de
arriba hacia abajo.
...
Ver carpeta `exercises/chapter_08/`.
