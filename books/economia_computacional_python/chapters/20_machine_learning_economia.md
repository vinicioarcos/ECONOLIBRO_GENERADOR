# Capitulo 20. Introduccion a machine learning para economia
...
El notebook asociado debe vivir en `notebooks/chapter_20/` y ejecutarse de
arriba hacia abajo.
...
Ver carpeta `exercises/chapter_20/`.
