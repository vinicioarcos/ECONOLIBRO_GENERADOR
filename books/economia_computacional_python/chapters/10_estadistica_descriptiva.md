# Capitulo 10. Estadistica descriptiva computacional
...
El notebook asociado debe vivir en `notebooks/chapter_10/` y ejecutarse de
arriba hacia abajo.
...
Ver carpeta `exercises/chapter_10/`.
