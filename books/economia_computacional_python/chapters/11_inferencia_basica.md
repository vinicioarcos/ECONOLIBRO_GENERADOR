# Capitulo 11. Distribuciones, muestreo e inferencia basica
...
El notebook asociado debe vivir en `notebooks/chapter_11/` y ejecutarse de
arriba hacia abajo.
...
Ver carpeta `exercises/chapter_11/`.
