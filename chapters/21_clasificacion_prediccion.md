# Capitulo 21. Clasificacion y prediccion economica
...
El notebook asociado debe vivir en `notebooks/chapter_21/` y ejecutarse de
arriba hacia abajo.
...
Ver carpeta `exercises/chapter_21/`.
