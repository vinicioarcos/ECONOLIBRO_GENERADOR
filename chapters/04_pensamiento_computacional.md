# Capitulo 04. Pensamiento computacional aplicado a problemas economicos
...
El notebook asociado debe vivir en `notebooks/chapter_04/` y ejecutarse de
arriba hacia abajo.
...
Ver carpeta `exercises/chapter_04/`.
