# Capitulo 22. Clustering y segmentacion economica
...
El notebook asociado debe vivir en `notebooks/chapter_22/` y ejecutarse de
arriba hacia abajo.
...
Ver carpeta `exercises/chapter_22/`.
